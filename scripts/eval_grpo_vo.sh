#!/usr/bin/env bash
#SBATCH --job-name=vlm-eval-grpo-vo-8b
...
#SBATCH --output=/home/%u/vlm-finetuning-project1/logs/eval_grpo_vo_8b_%j.out
#SBATCH --error=/home/%u/vlm-finetuning-project1/logs/eval_grpo_vo_8b_%j.err
...
echo "======================================================================"
echo "[PHASE 1/3] Running Inference on 8B GRPO Checkpoint (Violations Only)"
echo "======================================================================"
python -m experiments.run_inference \
    --tier 8b \
    --variant vo-grpo-8b-v1 \
    --checkpoint final \
    --batch_size 32 \
    --task violations_only

PREDS_DIR="$HPC_DRIVE_ROOT/results/inference/vo-grpo-8b-v1_final"
...
python -m experiments.run_evaluation \
    ...
    --wandb_run_name "qwen3-8b-vo-grpo-v1-repaired" \
    --task violations_only

echo "======================================================================"
echo "GRPO VO 8B Evaluation completed successfully: $(date)"
