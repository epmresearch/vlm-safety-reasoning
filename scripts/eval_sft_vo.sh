#!/usr/bin/env bash
#SBATCH --job-name=vlm-eval-sft-vo-8b
...
#SBATCH --output=/home/%u/vlm-finetuning-project1/logs/eval_sft_vo_8b_%j.out
#SBATCH --error=/home/%u/vlm-finetuning-project1/logs/eval_sft_vo_8b_%j.err
...
echo "======================================================================"
echo "[PHASE 1/3] Running Inference on 8B SFT Best Checkpoint (Violations Only)"
echo "======================================================================"
...
PREDS_DIR="$HPC_DRIVE_ROOT/results/inference/vo-sft-8b-v1_best"
...
python -m experiments.run_evaluation \
    ...
    --wandb_run_name "qwen3-8b-vo-sft-v1-repaired" \
    --task violations_only

echo "======================================================================"
echo "SFT VO 8B Evaluation completed successfully: $(date)"
