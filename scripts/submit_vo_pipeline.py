#!/usr/bin/env python3
"""
Submits the Violations-Only pipeline. Thin wrapper around scripts/submit_pipeline.py,
...
Usage:
    python scripts/submit_vo_pipeline.py --tiers 2b 4b 8b --version v1
...
the 'vo' task prefix, so this can run concurrently with the other three
...
if __name__ == "__main__":
    main(task_default="violations_only")
