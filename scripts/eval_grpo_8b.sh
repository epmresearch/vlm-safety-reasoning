#!/usr/bin/env bash
#SBATCH --job-name=vlm-eval-grpo-8b
...
#SBATCH --output=/home/%u/vlm-finetuning-project1/logs/eval_grpo_8b_%j.out
#SBATCH --error=/home/%u/vlm-finetuning-project1/logs/eval_grpo_8b_%j.err
...
echo "======================================================================"
echo "[PHASE 1/3] Running Inference on 8B GRPO Model"
echo "======================================================================"
...
PREDS_DIR="$HPC_DRIVE_ROOT/results/inference/unified-grpo-8b-v1_checkpoint-836"
