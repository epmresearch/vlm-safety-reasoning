#!/usr/bin/env bash
#SBATCH --job-name=vlm-grpo-vo-8b
...
#SBATCH --output=/home/%u/vlm-finetuning-project1/logs/grpo_vo_8b_%j.out
#SBATCH --error=/home/%u/vlm-finetuning-project1/logs/grpo_vo_8b_%j.err
...
echo "Starting GRPO training for 8B model (Violations Only Task)..."
python -m experiments.run_grpo \
    --tier 8b \
    --variant vo-grpo-8b-v1 \
    --sft_variant vo-sft-8b-v1 \
    --task violations_only

echo "GRPO 8B (Violations Only) training completed: $(date)"
