...
# (base_oo_<jobid>.out, base_co_<jobid>.out...).
...
TIER=$2
VERSION=$3
if [ -z "$TASK" ] || [ -z "$TIER" ] || [ -z "$VERSION" ]; then
    echo "Error: Arguments missing (Usage: hpc_baseline.sh <task> <tier> <version>, e.g. object_only 2b v1)"
    exit 1
fi
...
WANDB_TAG="$RUN_NAME"
echo "Baseline run name: $RUN_NAME"

echo "======================================================================"
echo "[STEP 1/3] Running Inference on ${TIER} Baseline Checkpoint (task=$TASK)"
echo "======================================================================"
# No --variant: run_inference takes the no-adapter path and --run_name alone
# determines the results folder.
...
PREDS_DIR="$HPC_DRIVE_ROOT/results/inference/$RUN_NAME"
PREDS_FILE="$PREDS_DIR/predictions.jsonl"

echo "======================================================================"
echo "[STEP 2/3] Running Structural Repair (task=$TASK)"
echo "======================================================================"
...
echo "======================================================================"
echo "[STEP 3/3] Running Full Evaluation Pipeline (task=$TASK)"
echo "======================================================================"
...
echo "======================================================================"
echo "Baseline ${TASK} ${TIER} evaluation completed successfully: $(date)"
echo "======================================================================"
