#!/usr/bin/env python3
"""
Submits the Unified (caption + objects + violations) pipeline. Thin wrapper around scripts/submit_pipeline.py,
...
Usage:
    python scripts/submit_unified_pipeline.py --tiers 2b 4b 8b --version v1
...
the 'unified' task prefix, so this can run concurrently with the other three
