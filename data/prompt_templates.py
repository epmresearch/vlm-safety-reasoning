...
UNIFIED_INSPECTION_PROMPT = (
    "Perform a construction safety inspection on this image. Output strictly a single JSON code block.\n\n"
    "1. For the 'caption' key: Provide a detailed description of foreground, background, workers, equipment, and conditions.\n"
    "2. For the object keys ('excavator', 'rebar', 'worker_with_white_hard_hat'): Provide bounding boxes [[xmin, ymin, xmax, ymax]] scaled from 0 to 1000. Return [] if absent.\n"
    ...
    "```json\n"
    '{"caption":"detailed description","rule_1_violation":{"bounding_box":[[...]],"reason":"..."},"rule_2_violation":null,"rule_3_violation":null,"rule_4_violation":null,"excavator":[[xmin, ymin, xmax, ymax]],"rebar":[],"worker_with_white_hard_hat":[[...]]}\n'
    "```"
)
